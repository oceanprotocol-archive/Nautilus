...
async function checkERC20Address() {
    let tokenAddress = await call(contract.methods.getERC20address('0x319d158c3a5d81d15b0160cf8929916089218bdb4aa78c3ecd16633afd44b8ae'));
    console.log("ERC20 token address is :=" + tokenAddress)
}
